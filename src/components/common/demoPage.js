    ...
    <div className="demo-page">
      <div className="jumbotron text-center">
        ...
        <p>
            <Link to="/signup" activeClassName="active"
             className="btn btn-lg btn-warning">Get started today
            </Link>
        </p>
      </div>
      ...
      <div className="row featurette">
          <div className="col-md-7">
            ...
            <p className="lead">With our App, you can Store, Edit and Manage Notes. The Colorful cards design add a nostalgic touch to the traditional notepad.</p>
          </div>
